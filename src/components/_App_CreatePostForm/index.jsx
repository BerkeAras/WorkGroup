        ...
        return (
            <div className="new_post">
                ...
                >
                    ...
                    <Modal.Content>
                        <div className="fake-textarea" onPaste={() => {setTimeout(function(){document.querySelector('.fake-textarea').innerHTML = convertToMarkup(document.querySelector('.fake-textarea').innerHTML)}, 100)}} role="textarea" placeholder="Share something about your thoughts…" contentEditable="true"></div>
                    </Modal.Content>
                    <Modal.Actions>

                        <div className="left-actions">
                            <Popup
                                trigger={<Button icon="picture" basic></Button>}
                                content='Upload images'
                                position='bottom left'
                            />
                            <Popup
                                trigger={<Button icon="file pdf" basic></Button>}
                                content='Upload PDF'
                                position='bottom left'
                            />
                        </div>
                ...
                >
                    ...
                    <Modal.Content>
                        Your post has been created and can now be read by other users!
                    </Modal.Content>
                    <Modal.Actions>
                ...
                >
                    ...
                    <Modal.Content>
                        Your post could not be published due to a server error! We are working to fix this bug.
                    </Modal.Content>
                    <Modal.Actions>
