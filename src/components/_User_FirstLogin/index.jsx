...
class FirstLogin extends React.Component {
    ...
    bannerUpload = () => {
        ...
        fetch(process.env.REACT_APP_API_URL + `/api/user/uploadBanner`, { // Your POST endpoint
            method: 'POST',
            //mode: 'no-cors',
            headers: myHeaders,
            body: formData
    ...
    avatarUpload = () => {
        ...
        fetch(process.env.REACT_APP_API_URL + `/api/user/uploadAvatar`, { // Your POST endpoint
            method: 'POST',
            //mode: 'no-cors',
            headers: myHeaders,
            body: formData
    ...
    render() {
        ...
        return (
            <Modal
                ...
                onClose={() => this.props.handleStateChange()}
                open={true}
                size="tiny"
            >
                ...
                <Modal.Content>
                    <Modal.Description>
                        ...
                        <p>
                            Get started and set up your account. Start adding your slogan, your department and more.
                        </p>
