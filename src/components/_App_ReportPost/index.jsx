            ...
            <Modal.Content>
                ...
                <Form>
                    ...
                    <Form.Radio
                        ...
                        value='other'
                        checked={reportTypeValue === "other"}
                        onChange={handleTypeChange}
                        disabled={reportIsLoading}
                    />
                    <h3>Please tell us what it is.</h3>
                    <TextArea disabled={reportIsLoading} value={reportTextValue} onChange={(e) => {setReportTextValue(e.target.value)}} placeholder="Please tell us what it is. (optional)" />
                </Form>
            </Modal.Content>
            <Modal.Actions>
