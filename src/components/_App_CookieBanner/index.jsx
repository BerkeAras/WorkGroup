    ...
    return (
        ...
        {(cookiesAccepted == false) && (
            <div className="cookie-banner">
                ...
                <p>
                    <Info />
                    We use cookies to improve our products, personalise your feed and advertising and to analyse how our products are used.<br />
                    Select &quot;Accept cookies&quot; to consent to this use or set your cookie selection under &quot;Manage settings&quot;.
                    You can change your cookie settings at any time and revoke your consent in your app-settings.
                </p>

                <Button onClick={acceptCookies} primary>Accept cookies</Button>
                <Button onClick={() => setShowCookieSettingsModal(true)}>Manage settings</Button>

            </div>
        )}
        <Modal className="cookie-modal" onClose={() => {setShowCookieSettingsModal(false)}} onOpen={() => setShowCookieSettingsModal(true)} open={showCookieSettingsModal} size="tiny">
            <Modal.Header>Manage your cookie settings</Modal.Header>
            <Modal.Content>
                We use cookies for advertising, analysis and to improve our features and products. You can use the &quot;Accept all cookies&quot; button to agree to cookies or adjust your selection.
                <br />
                <div className="cookie-explenation">
                   <Checkbox toggle label="Technical cookies" defaultChecked disabled /><br />
                   <p>Technical cookies are required for proper functionality of our products &amp; services.</p>
                </div>
                <div className="cookie-explenation">
                   <Checkbox toggle checked={analyticsCookiesChecked} onChange={() => {setAnalyticsCookiesChecked(!analyticsCookiesChecked)}} label="Analysis cookies" /><br />
            ...
            <Modal.Actions>
                <Button onClick={() => {setShowCookieSettingsModal(false)}}>
                    Dismiss
                </Button>
