                    ...
                    this.state.comments.map((comment) => {
                        return (
                            <Comment key={comment.id}>
                                {comment.avatar == '' ? <Comment.Avatar href={'/user/' + comment.email} src={unknownAvatar} /> : <Comment.Avatar href={'/user/' + comment.email} src={process.env.REACT_APP_API_URL + '/static/' + item.avatar} />}
                                <Comment.Content>
